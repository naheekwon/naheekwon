...
| No. | Title & Details |
|:--:|:--|
| [1] | Nahee Kwon **(First Author)**, **"[SCA: A Security-Calibrated Adapter for Concept Drift in Android Malware Detection]"**, *Korea Computer Congress (KCC) 2026*. **Accepted for Oral Presentation.** — Proposes a security descriptor-guided logit calibration module for Android malware detection under concept drift. SCA calibrates the backbone model's base logit using security descriptors, latent features, and sample-specific scale, bias, and residual corrections, enabling lightweight adaptation to distribution shifts without full model retraining. |
...
<tr>
  ...
  <td>
    <b>Academic Excellence Scholarship (1st in Year)</b>
    <ul>
      <li>Awarded for achieving the highest academic performance among students in the same year.</li>
    </ul>
  </td>
...
<sup><a href="./assets/awards/KCC%20우수논문상.pdf">[Certificate]</a></sup>
      <ul>
